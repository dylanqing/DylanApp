...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
    ...
    /*增加滑动监听为了解决onScrollListener这个事件在api23以下兼容的问题*/
    private setOnScrollListener mOnScrollChangedListener;

    public void setOnScrollListener(setOnScrollListener listener) {
