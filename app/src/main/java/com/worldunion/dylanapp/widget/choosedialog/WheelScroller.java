...
public class WheelScroller {
    ...
    public WheelScroller(Context context, ScrollingListener listener) {
        animationHandler = new WheelHandler(this);
    ...
    private static class WheelHandler extends NoneLeakHandler<WheelScroller>{

        public WheelHandler(WheelScroller obj) {
            super(obj);
        }

        @Override
        protected void handleNoneLeakMsg(Message msg, WheelScroller obj) {
